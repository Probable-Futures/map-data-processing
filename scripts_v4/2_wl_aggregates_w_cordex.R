    ...
    walk(doms, \(dom){
      ...
      s_wl_stats |> 
        iwalk(\(s, wl) {
          ...
          f_res <- str_glue("{dir_res}/CORDEX-CORE-ens_{dom}_{str_replace_all(v, '_', '-')}_wl-{wl}_stats.nc")
          ...
          str_glue("gcloud storage mv {f_res} {dir_gs_cordex}/warming_level_aggregates/{v}/{dom}/CORDEX_CORE_ensemble/") |> 
