...
### 02_ensemble.R
Creates ensemble statistics from derived variables across multiple climate models. This script:
...
### 03_mosaic.R
Creates global mosaic datasets by combining regional domain ensembles with inverse distance weighting. This script:
